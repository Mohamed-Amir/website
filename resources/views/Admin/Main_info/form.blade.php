                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email"> اسم الموقع </label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email"> شعار الموقع </label>
                                <input type="file" id="logo" name="logo" required class="form-control"   >
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email"> رقم التواصل </label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email"> ايميل التواصل </label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="example-email">عن الموقع </label>
                                <textarea type="text" id="about_site" name="about_site"  class="form-control"  required></textarea>
